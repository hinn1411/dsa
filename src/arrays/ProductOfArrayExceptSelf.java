...
public class ProductOfArrayExceptSelf {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("=== REVISE D2 ===");
    System.out.println(Arrays.toString(p.reviseD2(new int[]{1, 2, 3, 4})));
    System.out.println(Arrays.toString(p.reviseD2(new int[]{-1, 1, 0, -3, 3})));
    System.out.println(Arrays.toString(p.reviseD2(new int[]{1, 2})));
  }
}
